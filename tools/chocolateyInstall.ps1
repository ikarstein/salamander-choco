...
$packageName = 'salamander' # arbitrary name for the package, used in messages
$toolsDir = "$(Split-Path -parent $MyInvocation.MyCommand.Definition)"
$url = 'ftp://ftp.altap.cz/pub/altap/salamand/as40x86.exe' # download url
$url64 = 'ftp://ftp.altap.cz/pub/altap/salamand/as40x64.exe' # 64bit URL here or remove - if installer is both, use $url
$packageArgs = @{
	...
	silentArgs = '/x /s'
	validExitCodes = @(0)
	softwareName = 'salamander*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
